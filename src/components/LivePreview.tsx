...
import { 
  ...
  Mic, Gamepad2, Video, Users, TrendingUp,
  Sparkles, Star, Zap, Headphones, Clock, Trophy
} from "lucide-react";
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === "podcasts" && (
              ...
              >
                ...
                <div className="space-y-4">
                  {[
                    { 
                      ...
                      duration: "45 min",
                      plays: "12.4K",
                      image: "https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=200&q=80"
                    },
                    { 
                ...
                {/* Podcasts Features */}
                <div className="space-y-4">
                  <h3 className="text-2xl font-bold">Sports Podcasts & Audio</h3>
                  <div className="space-y-3">
                    {[
                      { icon: Mic, text: "Upload & share your own podcasts" },
